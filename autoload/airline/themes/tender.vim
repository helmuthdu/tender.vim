...
let s:normal3 = [ "#b3deef", "#333333", 153, 238 ]
...
let s:replace3 = [ "#f43753", "#333333", 203, 238 ]
...
let s:visual3 = [ "#ffc24b", "#333333", 215, 238 ]
let g:airline#themes#tender#palette.visual = airline#themes#generate_color_map(s:visual1, s:visual2, s:visual3)

let s:inactive1 = [ "#bbbbbb", "#333333", 250, 242 ]
let s:inactive2 = [ "#bbbbbb", "#333333", 250, 242 ]
